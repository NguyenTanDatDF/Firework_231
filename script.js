...
// Đặt một hàm để thêm class "fade-in" vào phần tử <p> sau một khoảng thời gian
setTimeout(function() {
...
document.addEventListener('DOMContentLoaded', function() {
	...
	var myElement = document.getElementById('constellation-sketcher');
	var myElement1 = document.getElementById('container1');
	var myElement3 = document.getElementById('containerr');
	// Đặt thời gian trễ (milliseconds)
	var delayTime = 48000; // Ví dụ: 2000ms = 2 seconds
	var audio3 = new Audio('newyear.mp3');
	audio3.currentTime = "47";
	audio3.play();
	audio3.volume = '0.5';
	...
	setTimeout(function() {
	  ...
	  setTimeout(function() {
		...
		var audio1 = new Audio('appear.mp3');
		audio1.play();

			setTimeout(function() {
				ConstellationSketcher.setDrawLines(false);
				ConstellationSketcher.setConstellation('Aquarius').sketch();
				var textNode = document.createTextNode("Gửi Bu aka 'Bình Bình' aka 'bạn bình thường mà'. Rất vui khi có duyên được gặp e trong năm qua, được đồng hành cùng em trong những hoạt động, những chuyến đi và những lúc suy lúc thường thường là một đoạn đáng nhớ trong hành trình của a hehe. Năm mới chúc em có thật nhiều sức khoẻ, niềm hạnh phúc bên gia đình và bạn bè. Chúc em năm sau sẽ có 1 công việc thật tốt với em nhé. Kết bài: hi vọng sẽ được đồng hành trên những đoạn tiếp theo. Hẹn gặp e một ngày khong xa.");

			// Tạo một phần tử <p> và thêm đoạn văn bản vào đó
			var paragraph = document.createElement("p");
			paragraph.appendChild(textNode);

			// Thêm phần tử <p> vào DOM
			document.body.appendChild(paragraph);

			// CSS cho phần tử <p> (để ban đầu nó ẩn đi và căn giữa màn hình)
			...
			paragraph.classList.add("fade-in");
			}, 4000); // 1000 milliseconds = 1 giây

		
			setTimeout(function() {
				myElement1.style.display= 'block';
			}, 25000); // 1000 milliseconds = 1 giây
	}, 17000); 
